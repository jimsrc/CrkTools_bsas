...
silent only
cd ~/software/CrkTools/arti
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +165 newprj-halley.sh
badd +87 do_halley.sh
badd +0 rain.pl
badd +0 genEspectra.pl
args newprj-halley.sh
edit newprj-halley.sh
...
exe 'vert 1resize ' . ((&columns * 82 + 92) / 184)
exe 'vert 2resize ' . ((&columns * 101 + 92) / 184)
argglobal
...
silent! normal! zE
let s:l = 152 - ((24 * winheight(0) + 23) / 47)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 96 - ((30 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
96
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 252 - ((4 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
252
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 372 - ((11 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
372
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 315 - ((7 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
315
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 113 - ((7 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
113
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 502 - ((16 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
502
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 454 - ((23 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
454
